  ...
  <div id="Content">
        ...
        <ul>
          <li class="Personality4"><a href="">设置</a>
            <ul class="Personality41">
              <li class="Personality42"><a href="EditUserMessage.jsp">编辑个人信息</a></li>
    ...
    <div id="VerticalBar">
      <div class="VerticalBar1">
        ...
        <div class="Same"><a href="#">团购订单</a></div>
        <div class="Same"><a href="#">我的预售</a></div>
      ...
      <div class="VerticalBar2">
        ...
        <div class="Same"><a href="#">关注的店铺</a></div>
        <div class="Same"><a href="#">关注的活动</a></div>
        <div class="Same"><a href="#">浏览历史</a></div>
      </div>
      <div class="VerticalBar3">
        <div class="VerticalBar41">
          <p>客户服务</p>
        </div>
        <div class="Same"><a href="#">价格保护</a></div>
        <div class="Same"><a href="#">意见建议</a></div>
        <div class="Same"><a href="#">购买咨询</a></div>
      </div>
      <div class="VerticalBar4">
        <div class="VerticalBar31">
          <p>资产中心</p>
        </div>
        <div class="Same"><a href="#">余额</a></div>
        <div class="Same"><a href="#">会员卡</a></div>
        <div class="Same"><a href="#">甜豆</a></div>
      </div>
    ...
    <div id="mymessage">
        ...
        <div class="inf">
          ...
          <div class="user-counts">
            <ul>
              ...
              <li>
                <div class="count-item"> <a href="#"><img src="assets/homeImages/fk.png" /> <i class="count-icon count-icon04"></i> 待评价 <em id="productCount">0</em> </a> </div>
              </li>
            </ul>
          </div>
          <div class="right">
            ...
            <div>
              <label>甜豆：</label>
              <a href="#">99999.00</a> </div>
          </div>
        </div>
      </div>
      <div class="clearfloat"></div>
      <div class="mymessage" id="AllOrders">
        <div class="AllOrders1"><a href="UserOrder.html">我的订单</a></div>
        <div class="AllOrders32"><a href="UserOrder.html">更多></a></div>
        <div class="clearfloat"></div>
        <div class="AllOrders4">
          <table class="AllOrders41" width="780" cellspacing="0" cellpadding="0" >
            <tr class="TabControl" >
              <td height="30">订单信息</td>
              <td height="30">收货人</td>
              <td height="30">订单金额</td>
            ...
            <tr class="OrdersNumber">
              <td height="30" colspan="6" style="text-align:left">订单编号:01010101</td>
            </tr>
            <tr class="Canceled">
              <td width="200" height="100" style="text-align:left"><img src="assets/homeImages/search/1.2.png" width="50" height="50" /><img src="assets/homeImages/gg1.jpg" width="50" height="50" /></td>
              <td width="73">莎莉</td>
              <td width="75">￥98.00<br />
                在线支付</td>
              <td width="88">2016-06-12 <br />
                10:30:07</td>
              <td width="76">已取消</td>
              <td width="82"><a href="#">查看</a>|<a href="#">删除</a>
      ...
      <div class="clearfloat"></div>
      <div class="mymessage">
        <div class="AllOrders1"><a href="UserFavorite.html">关注的商品</a></div>
        <div class="AllOrders32"><a href="UserFavorite.html">更多></a></div>
        <div class="clearfloat"></div>
        <table width="780" cellpadding="0" cellspacing="0">
          <div class="goods">
            <div class="p-img"> <a target="_blank" href="Goods.html"> <img width="160" height="160" data-img="1" alt="U100牌菠萝干" src="assets/homeImages/search/1.2.png"></a> </div>
            <div class="p-name">
              <input type="checkbox" value="996967" class="jdcheckbox" name="sku"/>
              <a alt="U100牌菠萝干" title="U100牌菠萝干" target="_blank" href="">U100牌菠萝干</a>
              <div class="p-price"> <strong price="10.68">¥10.68</strong> <span class="stock"></span> </div>
            </div>
          </div>
          <div class="goods">
            <div class="p-img"> <a target="_blank" href="Goods.html"> <img width="160" height="160" data-img="1" alt="U100牌蔓越莓干" src="assets/homeImages/gg1.jpg"></a> </div>
            <div class="p-name">
              <input type="checkbox" value="996967" class="jdcheckbox" name="sku"/>
          ...
          <div class="goods">
            <div class="p-img"> <a target="_blank" href="Goods.html"> <img width="160" height="160" data-img="1" alt="U100牌蜜桃干" src="assets/homeImages/search/4.1 (2).png"></a> </div>
            <div class="p-name">
              <input type="checkbox" value="996967" class="jdcheckbox" name="sku"/>
