...
href="#"><img
						...
						<form action="editUserInfo.action" method="post">
							...
							<div class="item">
								...
								<input type="text" value="${user.nickName} " name="nickName"
									id="text1" maxlength="20" class="itxt">
							</div>
							<div class="item">
							...
							<div class="item">
								...
								<select id="city" class="selt mr5" name="mouth"
									value="${user.mouth }">
									<option value="72">
										1
									</option>
								...
								<select id="county" name="day" class="selt mr5"
									value="${user.day }">
									<option value="2799">
										1
									</option>
							...
							<div class="item">
								...
								<input type="text" value="${user.cardId }" id="text4"
									name="cardId">
							</div>
							<div class="item">
								<input id="submit" type="submit" class="tj" value="提交" />
							</div>
						</form>
	...
	bt();
>
				<img src="assets/homeImages/totop.png" width="21" height="65" />
			</div>
		</div>
	</body>
</html>
