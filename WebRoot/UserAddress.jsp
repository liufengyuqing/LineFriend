...
<%@ page language="java" import="cn.edu.nwsuaf.entity.UserAddress"%>
		...
		<div id="con">
			<div id="Search">
				<div class="Search1">
					...
					<div class="welcome">
						<font size="+6" color="#CCCCCC">|</font><font size="+2">收货地址</font>
					</div>
				</div>
				<div class="Search2">
			...
			<div id="Content">
				...
				<div id="mymessage">
					...
					<c:forEach items="${addressList}" var="item" varStatus="status">
						<div class="addAddressFrame1">
							<div class="bigAddress">
								${item.receive_name}
							</div>
							...
							<div class="addressForm">
								<table width="400" border="0">
									...
									<tr>
										...
										<td class="rightTd">
											${item.province}省 ${item.city}市 ${item.district}区
										</td>
									</tr>
									<tr>
										<td class="leftTd" align="right">
							...
							<div class="addressOption">
								<a class="addressOption1" href="deleteAddress.action?id=${item.id} ">删除</a><a
									class="addressOption2" href="editAddress.action?id=${item.id}">编辑</a>
							</div>
						</div>
					</c:forEach>
